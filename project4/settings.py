...
SECRET_KEY = 'django-insecure-iaqjhy4^!+wxck&tyrj#7!+yg8@@!8x24h2s#0e#$r)78$1r!^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['project-4-pawoods.herokuapp.com', '8000-pawoods-project4-7virwu35hg.us1.codeanyapp.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # Do not remove
...
ACCOUNT_AUTHENITCATION_METHOD = 'username_email'
